...
popsim_multinomial <- function(obs, N, samples = 1000, alpha = rep(0.5, length(unique(obs)))) {
  ...
  for(i in 2:(samples + 1)) {
    ...
    for(k in 1:N) {
      ...
      proposal_lp <- logpost(as.numeric(table(proposal)), N, J, n, alpha)
...
<img src="figure/denscomp_binary-1.png" title="Comparison of density for N = 100 (left) and N = 1000 (right), showing Binomial (red) and Hypergeometric (blue)" alt="Comparison of density for N = 100 (left) and N = 1000 (right), showing Binomial (red) and Hypergeometric (blue)" width="50%" /><img src="figure/denscomp_binary-2.png" title="Comparison of density for N = 100 (left) and N = 1000 (right), showing Binomial (red) and Hypergeometric (blue)" alt="Comparison of density for N = 100 (left) and N = 1000 (right), showing Binomial (red) and Hypergeometric (blue)" width="50%" />
...
```r
prof_binom_100 <- as.matrix(flatProfile(popsim_binom_prof_100, byTotal = TRUE, GC = FALSE))[1:6, ]
prof_binom_1000 <- as.matrix(flatProfile(popsim_binom_prof_1000, byTotal = TRUE, GC = FALSE))[1:6, ]

prof_hyperg_100 <- as.matrix(flatProfile(popsim_hyperg_prof_100, byTotal = TRUE, GC = FALSE))[1:6, ]
prof_hyperg_1000 <- as.matrix(flatProfile(popsim_hyperg_prof_1000, byTotal = TRUE, GC = FALSE))[1:6, ]

prof_multinom_100 <- as.matrix(flatProfile(popsim_multinom_prof_100, byTotal = TRUE, GC = FALSE))[1:6, ]
prof_multinom_1000 <- as.matrix(flatProfile(popsim_multinom_prof_1000, byTotal = TRUE, GC = FALSE))[1:6, ]

prof_mvhyperg_100 <- as.matrix(flatProfile(popsim_mvhyperg_prof_100, byTotal = TRUE, GC = FALSE))[1:6, ]
prof_mvhyperg_1000 <- as.matrix(flatProfile(popsim_mvhyperg_prof_1000, byTotal = TRUE, GC = FALSE))[1:6, ]

kables(
  list(
    kable(prof_binom_100, col.names = c("Total %", "Total Time", "Self %", "Self Time"), caption = "Profiling for K Method") %>%
      kable_styling(full_width = FALSE, position = "float_left"),
    kable(prof_binom_1000, col.names = c("Total %", "Total Time", "Self %", "Self Time"), caption = "Profiling for p Method") %>%
...
kables(
  list(
    kable(prof_hyperg_100, col.names = c("Total %", "Total Time", "Self %", "Self Time"), caption = "Profiling for K Method") %>%
      kable_styling(full_width = FALSE, position = "float_left"),
    kable(prof_hyperg_1000, col.names = c("Total %", "Total Time", "Self %", "Self Time"), caption = "Profiling for p Method") %>%
      kable_styling(full_width = FALSE, position = "float_right")
  ),
...
kables(
  list(
    kable(prof_multinom_100, col.names = c("Total %", "Total Time", "Self %", "Self Time"), caption = "Profiling for K Method") %>%
      kable_styling(full_width = FALSE, position = "float_left"),
    kable(prof_multinom_1000, col.names = c("Total %", "Total Time", "Self %", "Self Time"), caption = "Profiling for p Method") %>%
      kable_styling(full_width = FALSE, position = "float_right")
  ),
...
kables(
  list(
    kable(prof_mvhyperg_100, col.names = c("Total %", "Total Time", "Self %", "Self Time"), caption = "Profiling for K Method") %>%
      kable_styling(full_width = FALSE, position = "float_left"),
    kable(prof_mvhyperg_1000, col.names = c("Total %", "Total Time", "Self %", "Self Time"), caption = "Profiling for p Method") %>%
      kable_styling(full_width = FALSE, position = "float_right")
  ),
...
<th style="border-bottom:hidden;padding-bottom:0; padding-left:3px;padding-right:3px;text-align: center; " colspan="3"><div style="border-bottom: 1px solid #ddd; padding-bottom: 5px; ">K</div></th>
</tr>
  <tr>
   <th style="text-align:left;">   </th>
