...
#> Error in as.matrix(flatProfile(popsim_hyperg_prof_1000, byTotal = TRUE, : subscript out of bounds
...
kables(
  ...
  kable_styling(full_width = TRUE)
#> Error in kable(prof_hyperg_1000, col.names = c("Total %", "Total Time", : object 'prof_hyperg_1000' not found
...
<tbody>
  <tr>
   ...
   <td style="text-align:right;"> 124.04 </td>
...
<tbody>
  <tr>
   ...
   <td style="text-align:right;"> 133.64 </td>
  ...
  <tr>
   ...
   <td style="text-align:right;"> 130.80 </td>
