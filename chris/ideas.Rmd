...
```{r, echo = FALSE, out.width = "100%", fig.height = 3, fig.cap = "Membership of $Y_N \\setminus X_n$ for a single sample across various synthetic populations (red) and true population (black)"}
g1 <- data.frame(
  "Window" = 1:(n + 1),
