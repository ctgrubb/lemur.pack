...
rm(list = setdiff(ls(), c("sample", "population", "iterations")))
```


```{r indNormal}
indNormalMCMC <- function(sample, population, ranges, iterations = 1000) {
...
```{r}
test <- indNormalMCMC(sample, population, 200)
